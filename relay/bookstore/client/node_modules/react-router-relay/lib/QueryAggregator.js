  ...
  QueryAggregator.prototype.updateQueryConfig = function updateQueryConfig(routerProps) {
    ...
    routes.forEach(function (route, i) {
      ...
      (0, _keys2.default)(componentMap).forEach(function (key) {
        ...
        !_classic2.default.isContainer(component) ? process.env.NODE_ENV !== 'production' ? (0, _invariant2.default)(false, 'relay-router-relay: Route with queries specifies component `%s` ' + 'that is not a Relay container.', component && (component.displayName || component.name)) : (0, _invariant2.default)(false) : void 0;
